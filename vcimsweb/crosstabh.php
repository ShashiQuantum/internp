...
$data = $pqtdata = get_project_question_term($pid);
if(!empty($fpdata)) $data=array_merge($fpdata,$pqtdata);
...
<img src="https://www.digiadmin.quantumcs.com/siteadmin/public/img/logos/Digiadmin_logow.png" style="float:left;height:30px;width:90px;">
