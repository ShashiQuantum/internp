...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Janakpuri -Delhi</option><option value=2>Paschim Vihar - Delhi</option><option value=3>Gachibowli -Hyderabad</option><option value=4>Central Food court -Hyderabad</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Chicken Bite Bowlz Only</option><option value=2>Chicken Bite Bowl Meal With Pepsi</option><option value=3>Chicken Bite Bowlz with 2 Piece Chicken</option></select></td></tr>
    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( `full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ('$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `rock_14`( `q_id`,`resp_id`,`r_name_14`,mobile_14,`age_14`, `gen_14`, `sec_14`, `week_d_14`,`store_14`, `products_14`,`age_yrs_14`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
