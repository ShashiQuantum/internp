...
if($_GET['next']==3)
{
	...
	echo '<br>Your Survey has reset, Pls fill the survey from begning';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=-1&rsp=$resp_id";
...
if(isset($_POST['submit']))
{
	...
	echo '<br>Thank You! Submitted';
        ...
        if($qset==27)
           {  $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fqt27.php?qset=$qset";}
        if($qset==23)
           { $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_23.php?qset=$qset";}
        if($qset==24)
           { $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fq24.php?qset=$qset";}
        if($qset==13)
           { $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_13.php?qset=$qset";}
        if($qset==26)
           { $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fq26.php?qset=$qset";}
        if($qset==25)
           { $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fq25.php?qset=$qset";}
        //else
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                          ...
                          $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=-1&rsp=$resp_id");
                	...
                	if($sh)
                        {
                            ...
                            {  //<a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."></a>
                                if($h->qsec_id==$psec)
...
OR all_prod_exposed !=  '')");
   ...
   //         	}
                               echo '<br><br><br>';
		  echo "<div id=footer>";
					//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='?qset=$qset&next=1&rsp=$resp_id'><input type='submit' name='save' value='Save & Next' style=background-color:#004c00;color:white;height:35px;></a>";

      echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=1&rsp=$resp_id#'> <input type='submit' name='save' value='Save & Next' onclick='return Validate();' style='background-color:#004c00;color:white;height:35px;position:absolute; left:50%;'></a> </center> ";
...
echo "</div>"; 
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }
                ...
                echo 'You have entered wrong URL, pls use your correct URL';
                        ...
                        //start===================================================================================================================================
                                ...
                                {   
                                    ...
                                    if( $q==60)
                                    {
                                           // $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=1&rsp=$resp_id&sec=$qsec&msg=1";
                                           //header('Location: '.$newURL);  
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                //https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id.";
...
echo "</div>";
 ...
 echo "<tr height=40><td></td><td>&nbsp;&nbsp;&nbsp;<select  name=text$currq style='font-size:1.2em;'> <option >0</option><option >1</option><option>2</option><option >3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option >11</option><option >12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option >19</option><option >20</option><option > 21</option><option >22</option><option >23</option><option >24</option><option >25</option><option >26</option><option >27</option><option >28</option><option >29</option><option >30</option><option >31</option> </select></td></tr>";
                        ...
                        {           
                            ...
                            //get top rank company other than client
                            $rating1_heading='Best Rating';$cc='';$rank1c='';
                            $r1=DB::getInstance()->query("SELECT `project_id`, `name`, `company_name`, `brand`, `background`, `tot_visit`, `research_type` FROM `project` WHERE `project_id`=3");
                            if($r1->count()>0)
                            {
...
OR all_prod_exposed !=  '')");
  ...
  echo "<br><div id=footer>";
			//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey_v2.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a>";
