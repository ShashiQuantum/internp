...
if($_GET['next']==3)
{
       ...
       echo $qqq="DELETE FROM  `demosurvey2` WHERE  `resp_id` =$resp_id AND  `r_age` ='' ";
...
if(isset($_POST['submit']))
{
	...
	echo '<br>Thank You! Submitted';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_testing.php?qset=$qset&yn=0";
        header('Location: '.$newURL);        
}
else
{
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                           ...
                           $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=-1&rsp=$resp_id");
                ...
                {    
                    ...
                    {   //echo $p->q_id;    
                                ...
                                //find the selected option by user from database
                                        ...
                                        if($qtd1->first()->q_type=='radio' || $qtd1->first()->q_type=='text' || $qtd1->first()->q_type=='textbox'|| $qtd1->first()->q_type=='textarea' || $qtd1->first()->q_type=='checkbox' || $qtd1->first()->q_type=='calculated' || $qtd1->first()->q_type=='sec')
                	...
                	if($sh)
                        {
                            ...
                            {
                                if($h->qsec_id==$psec)
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#00e500;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                else
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
...
echo "</div>";
        ...
        */                
                            ...
                            {       $q_title=$rs2->first()->q_title;
                               ...
                               $currq=$cq->q_id;
                                ...
                                {           echo '<table><tr><td><b><font color=black> '.$rs2->first()->q_title.'</font></b></td></tr></table><br>';
                                    ...
                                    echo "<table><tr><td width=4%>$currq</td><td colspan=2><font color=blue> $q_title </font></td></tr>";   
                        ...
                        if($qt=='calculated')
                        {
                                ...
                                echo "<br>How many number of pack do you consume in a year?";
                                echo "<br><input type=number min=0 name=tp id=tp value=$str1 placeholder='enter total pack in a year'>";
                                echo "<br><br>What is the average pack weight/size?";
                                echo "<br><input type=number min=0 name=ps id=ps value=$str2 placeholder='enter a pack size'>";
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr><td></td><td colspan=2><textarea name=text$currq cols=150 rows=5 placeholder='type your response here'>$str</textarea> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        }else if($qt=='text')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                                if($rss)
                            ...
                            echo "<tr><td></td><td colspan=2><input type=text name=text$currq size=60 placeholder='type your response here' value=$str> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        ...
                        else if($qt=='radio')
                        {
                            ...
                            {   
                                ...
                                echo "<tr><td></td><td width=2%><input type='$qt' class='xa' name='$op->term' $str value='$op->value' ></td><td> $op->opt_text_value </td></tr>";
                            }
                        }
                        else if($qt=='checkbox')
                        {   $j=0;
                            ...
                            {   $j++;
                                ...
                                echo "<tr><td></td><td width=2%><input type='$qt' class='xa' name='$op->term$op->value' $str value='$op->value'></td><td> $op->opt_text_value </td></tr>";
                            }
                        }
...
echo "<div id=header>";
                            echo "<div style=float:right><img src='../../images/Digiadmin_logo.jpg' height=30 width=130> </div>";
echo "</div>"; 
                                echo '<p><font color=blue>'.$rs2->first()->q_title.'</font></p>';
                                $qt=$rs2->first()->q_type;
                                $ifvideo=$rs2->first()->video;
                                $ifaudio=$rs2->first()->audio;
                                $ifimage=$rs2->first()->image;
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }}
                else
                {
                ...
                echo 'You have entered wrong URL, pls use your correct URL';
                        ...
                        //start===================================================================================================================================
                                ...
                                {   
                                    ...
                                    {
                                        echo "<font color=red>Please fill all the questions of previous section to be proceed...</font>";
                                    }
                                    else
                                    {
                                ...
                                if($df->count() > 0)   
                                    ...
                                    {   $qctr++;
                                       //echo '<br>ctr:'. $qctr;
                                        ...
                                        if($qqtype=='instruction' || $qqtype=='top3rankcompany')
                                            {$qctr--;continue;}
                                        else if($qqtype=='text' || $qqtype=='textarea' || $qqtype=='radio'|| $qqtype =='rating' || $qqtype=='calculated')
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#004c00;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                    else
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
                            echo '</tr></table></center><br>';
                        }//end display tab
                        ...
                        echo "<br><center><font color='red'>Thanks for your participation in the survey. <br>You can review your responses to all previous questions before final submission of the survey otherwise click on submit button to complete survey</font></center>";
                        echo "<br><br><center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='next' value='Previous' style=background-color:#004c00;color:white;height:50px;></a> <input type='submit' name='submit' value='Submit Survey' style=background-color:#004c00;color:white;height:50px;></center>";
                }
               else 
                {
                    $ctr=0;
...
echo "</div>";
                     ...
                     */   
                      ...
                      $qq="SELECT distinct `q_id`,`qset_id` FROM `question_routine_detail` WHERE `qset_id` = $qset and `qsec` in ($qsec) order by `q_id`"; 
                            ...
                            {       
                               ...
                               array_push($qlist,$currq); 
                                ...
                                {           echo '<table><tr><td><b><font color=black> '.$rs2->first()->q_title.'</font></b></td></tr></table><br>';
                                    ...
                                    echo '<table><tr><td width=4%>'.$currq.'</td><td colspan=2><font color=blue> '.$rs2->first()->q_title.'</font><font color=red><span id='.$error.'></span></font></td></tr>';   
                        ...
                        if($qt=='calculated')
                        {
                                ...
                                echo "<br>How many number of pack do you consume in a year?<br>";
                                echo "<br><input type=number min=0 name=tp id=tp value=$str1 placeholder='enter total pack in a year'>";
                                echo "<br><br>What is the average pack weight/size?<br>";
                                echo "<br><input type=number min=0 name=ps id=ps value=$str2 placeholder='enter a pack size'>";
                               ...
                               /*
                                $sd=''; $ss=$str; $p='';$e='';
                                                ...
                                                {$sd=A1; $p='';$e='';}
                                                    ...
                                                    $sd=9;
                                                */
                            echo '<table><tr><td><font face=tahoma color=blue>Please select the occupation of the person who makes the highest contribution to your household expenditure?</font></td><td>';
                            echo "<br><select name=sec_occup><option value=0>--Select--</option><option value=1>Unskilled Workers</option><option value=2>Skilled Workers</option><option value=3>Petty traders</option><option value=4>Shop owners</option><option value=5>Businessman/Industrialists with no Employees</option><option value=6>Businessman/Industrialists with 1-9 no of Employees</option><option value=7>Businessman/Industrialists with 10+ Employees</option><option value=8>Self employed professionals</option><option value=9>Clerical/Salesman</option><option value=10>Supervisory level</option><option value=11>Officers/Executives – Junior</option><option value=12>Officers/Executives-Middle/Senior</option></select></td></tr>";
                            echo '<tr><td><font face=tahoma color=blue>Please select the education of the person who makes the highest contribution to your household expenditure? </font></td><td>';
                            echo "<br><select name=sec_educ><option value=0>--Select--</option><option value=1>Illitrate</option><option value=2>Literate no formal education</option><option value=3>School upto 4 yrs</option><option value=4>School 5-9 yrs</option><option value=5>HSC/SSC</option><option value=6>Some college but not Grad</option><option value=7>Grad/Post Grad Gen</option><option value=8>Grad/Post Grad Prof</option></select></td></tr></table>";
                            //echo $sec[6][7];
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr><td></td><td><textarea id=q$currq name=text$currq cols=60 rows=3 placeholder='type your response here'>$str</textarea> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";
                        ...
                        }else if($qt=='text')
                        {
                            ...
                            echo "<tr><td></td><td><input type=text id=q$currq name=text$currq size=60 placeholder='type your response here'  value=$str > OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        }else if($qt=='textrating')
                        {
                            $rd=DB::getInstance()->query("SELECT distinct text_term, rating_term FROM `question_option_detail` WHERE `q_id`=$currq");
                            if($rd)
                        ...
                        else if($qt=='radio')
                        {
                            ...
                            {   
                                ...
                                echo "<tr><td></td><td width=2%><input type='$qt' class='xa' id=q$currq name=q$currq $str value='$op->value'></td><td> $op->opt_text_value</td></tr>";
                            }
                        }
                        else if($qt=='checkbox')
                        {   $j=0;
  ...
  echo "<div id=footer>";
			echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id#'><input type='submit' name='save' value='Save & Next' onclick='return Validate();' style=background-color:#004c00;color:white;height:35px;></a> ";
...
<script src="audio_recording.html">
<script type="text/javascript">
