...
<!DOCTYPE html>
<html>
<head><title>View Question Sequence</title></head>
<body>
<center>
<br><br><h2>View Project's Questions Sequence</h2><br><br>
...
<?php
	...
	if(isset($_POST['question_view']))
	{
	    //print_r($_POST);
	    	$pid=$_POST['pn'];
	    	$qset=$_POST['qset'];
	    	$qry="Select * from question_sequence where qset_id=$qset order by qid";
