...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Dwarka Delhi</option><option value=2>Ambience Mall, Vasant Kunj Delhi</option> </select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered_07"><option value=1>Smoky Grill'd Burger</option><option value=2> Smoky Grill'd Burger Meal</option></select></td></tr>
...
if(isset($_POST['subinfo']))
{
    ...
    if(($fn!='') && ($mob!='') )
    {
        ...
        {       
            ...
            {    
                echo '<br><font color="red">Your survey has submitted once, So you could not participated again for same survey</font>';
            }
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `peacock_9`( `q_id`,`resp_id`,`r_name_9`,mobile_9,`r_age_9`, `r_gen_9`, `r_sec_9`, `weekday_9`,`store_17`, `product_17`,`r_age_yrs_9`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
