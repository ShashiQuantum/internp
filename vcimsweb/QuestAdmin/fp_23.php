...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>CP2(5th/8th Feb)</option><option value=2>Saket(5th/8th Feb)</option><option value=3>CP2 (11/12 Feb)</option><option value=4>Saket (11/12 Feb)</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Snacker with Thousand island sauce- STIS</option><option value=2>Snacker with New Achari mayo-SNAM</option><option value=3>Longer with New Achari mayo-LNAM</option><option value=4>Longer with Thousand island sauce-LTIS</option></select></td></tr>
        <tr><td>Concept <font color="red">*</font> </td><td><select name="concept"><option value=1>Concept 1- STIS</option><option value=2>Concept 2- SMM </option><option value=3>Concept 3- LMM </option><option value=4>Concept 4- LTIS </option></select></td></tr>

        <tr><td>Category HML <font color="red">*</font> </td><td><select name="chml"><option value=1>Category - Heavy</option><option value=2>Category - Medium</option><option value=3>Category - Light </option></select></td></tr>
        <tr><td>KFC - HML <font color="red">*</font> </td><td><select name="khml"><option value=1>KFC - Heavy</option><option value=2>KFC - Medium</option><option value=3>KFC - Light </option></select></td></tr>

       <tr><td>Student/Working <font color="red">*</font> </td><td><select name="rq8"><option value=1>Student</option><option value=2>Working</option></select></td></tr>
    ...
    { 
        ...
        {       
            ...
            else if($da->first()->status==0 || $da->first()->status==1)
            {
               ...
               // echo $sq="INSERT INTO `BLOSSOM_23`( `q_id`,`resp_id`,`r_name`,mobile,`age_23`, `gender_23`, `sec_23`, `week_day_23`,`store_23`, `product_23`,`age_yrs_23`,`chml_23`,`kfchml_23`,`concept_23`,rq8_23) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs','$chml','$khml','$concept','$rq8')";

//DB::getInstance()->query($sq);
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `BLOSSOM_23`( `q_id`,`resp_id`,`r_name`,mobile,`age_23`, `gender_23`, `sec_23`, `week_day_23`,`store_23`, `product_23`,`age_yrs_23`,`chml_23`,`kfchml_23`,`concept_23`, rq8_23) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs','$chml','$khml','$concept','$rq8')");
