    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `FUDGE_30`( `q_id`,`resp_id`,`r_name`,mobile,`age_30`, `gender_30`, `sec_30`, `week_day_30`, `product_30`,`age_yrs_30`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$ord_prod','$age_yrs')");
