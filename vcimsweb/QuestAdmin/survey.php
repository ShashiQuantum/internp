...
if($_GET['next']==3)
{
	...
	echo '<br>Your Survey has reset, Pls fill the survey from begning';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=-1&rsp=$resp_id";
...
if(isset($_POST['submit']))
{
	...
	echo '<br>Thank You! Submitted';
        ...
        if($qset==10)
            $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_10.php?qset=$qset&yn=0";
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                          ...
                          $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=-1&rsp=$resp_id");
                	...
                	if($sh)
                        {
                            ...
                            {
                                if($h->qsec_id==$psec)
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#00e500;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                else
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
...
OR all_prod_exposed !=  '')");
   ...
   //         	}
                               echo '<br><br><br>';
		  echo "<div id=footer>";
					//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='?qset=$qset&next=1&rsp=$resp_id'><input type='submit' name='save' value='Save & Next' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id#'> <input type='submit' name='save' value='Save & Next' onclick='return Validate();' style='background-color:#004c00;color:white;height:35px;position:absolute; left:50%;'></a> </center> ";
...
echo "</div>"; 
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }}}
                else
                {
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#004c00;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                    else
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
                            echo '</tr></table></center><br>';
                        }//end display tab
               */
                     ...
                     */   
                       ...
                       $qlist=array();$qid=0;
                        ...
                        {    
                           ...
                           if($currq== 275 || $currq== 276 || $currq== 277 || $currq== 278 )
                           {
                                    if($rss2->count()>0) 
                                         { $str=$rss2->first()->$column;
                                              echo "<tr height=40><td></td><td>&nbsp;&nbsp;<select  name=text$currq style='font-size:1.2em;'><option>$str</option> <option  value=1>Rs.11-20</option><option value=2>Rs.21-30</option><option  value=3>Rs.31-40</option><option  value=4>Rs.41-50</option><option  value=5>Rs.51-60</option><option  value=6>Rs.61-70</option><option  value=7>Rs.71-80</option><option  value=8>Rs.81-90</option><option  value=9>Rs.91-100</option><option  value=10>Rs.101-110</option><option   value=11>Rs.111-120</option><option  value=12>Rs.121-130</option><option  value=13>Rs.131-140</option><option  value=14>Rs.141-150</option><option  value=15>Rs.151-160</option><option  value=16>Rs.161-170</option><option  value=17>Rs.171-180</option><option  value=18>Rs.181-190</option><option  value=19>Rs.191-200</option><option   value=20>Rs.201-210</option><option  value=21>Rs.211-220</option><option value=22>Rs.221-230</option><option   value=23>Rs.231-240</option><option  value=24>Rs.241-250</option><option   value=25>Rs.251-260</option><option   value=26>Rs.261-270</option><option   value=27>Rs.271-280</option><option   value=28>Rs.281-290</option><option   value=29>Rs.291-300</option> </select></td></tr>"; 
            
                                          }else
                                      echo "<tr height=40><td></td><td>&nbsp;&nbsp;<select  name=text$currq style='font-size:1.2em;'> <option  value=1>Rs.11-20</option><option value=2>Rs.21-30</option><option  value=3>Rs.31-40</option><option  value=4>Rs.41-50</option><option  value=5>Rs.51-60</option><option  value=6>Rs.61-70</option><option  value=7>Rs.71-80</option><option  value=8>Rs.81-90</option><option  value=9>Rs.91-100</option><option  value=10>Rs.101-110</option><option   value=11>Rs.111-120</option><option  value=12>Rs.121-130</option><option  value=13>Rs.131-140</option><option  value=14>Rs.141-150</option><option  value=15>Rs.151-160</option><option  value=16>Rs.161-170</option><option  value=17>Rs.171-180</option><option  value=18>Rs.181-190</option><option  value=19>Rs.191-200</option><option   value=20>Rs.201-210</option><option  value=21>Rs.211-220</option><option value=22>Rs.221-230</option><option   value=23>Rs.231-240</option><option  value=24>Rs.241-250</option><option   value=25>Rs.251-260</option><option   value=26>Rs.261-270</option><option   value=27>Rs.271-280</option><option   value=28>Rs.281-290</option><option   value=29>Rs.291-300</option> </select></td></tr>"; 
                             ...
                             }else if($currq==330)
                               {
                                        ...
                                        if($rss2->count()>0) 
                                         { $str=$rss2->first()->$column;
                                            echo "<tr height=40><td></td><td>&nbsp;&nbsp;<select  name=text$currq style='font-size:1.2em;'><option>$str</option> <option >0</option><option >1</option><option>2</option><option >3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option >11</option><option >12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option >19</option><option >20</option><option >21</option><option >22</option><option >23</option><option >24</option><option >25</option><option >26</option><option >27</option><option >28</option><option >29</option> </select></td></tr>"; 
                                         }
                                         else
                                         {
 echo "<tr height=40><td></td><td>&nbsp;&nbsp;&nbsp;<select  name=text$currq style='font-size:1.2em;'> <option >0</option><option >1</option><option>2</option><option >3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option >11</option><option >12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option >19</option><option >20</option><option > 21</option><option >22</option><option >23</option><option >24</option><option >25</option><option >26</option><option >27</option><option >28</option><option >29</option> </select></td></tr>";
...
OR all_prod_exposed !=  '')");
  ...
  echo "<div id=footer>";
			//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/survey.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a>";
