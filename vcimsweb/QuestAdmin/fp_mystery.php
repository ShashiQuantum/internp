...
$qset=$_GET['qset'];
$url="http://wwww.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_mystery.php?qset=$qset";
...
?>
        ...
        <tr><td>Full Pub/Venue Name <font color="red">*</font> </td><td><input type="text" name="fname" size="40"></td></tr>
        <tr><td>Venue Address  </td><td><input type="text" name="address" size="40"></td></tr>
        <tr><td>Telephone <font color="red"> </font> </td><td><input type="text"  maxlength=10 minlength=10 name="tele" onkeypress="return isNumber(event)"></td></tr>
        
        <tr><td>Name of Auditor <font color="red">*</font> </td><td><input type=text name="aud_name" size="40"></td></tr>
        <tr><td>Auditor's Mobile<font color="red">*</font> </td><td><input type="text" maxlength=10 minlength=10 name="mobile" onkeypress="return isNumber(event)"></td></tr>
        ...
        ?>
        <tr><td>City/Centre<font color="red">*</font></td><td><select name='centre'><?php if($dc1->count()>0)foreach($dc1->results() as $d){ echo "<option value=$d->centre_id>$d->cname</option>";}?></select> </td></tr>
    ...
    { 
        ...
        {       
            ...
            else if($da->first()->status==0 || $da->first()->status==1)
            {
               ...
               //DB::getInstance()->query("INSERT INTO `utsab_11`( `resp_id`, `q_id`, `pub_name`, `pub_mob`, `aud_name`, `aud_mob`) VALUES ($resp_id,$qset,'$fn','$tele','$aud_nm','$mob')");
