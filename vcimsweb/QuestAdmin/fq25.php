...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Yum Powai (169)</option><option value=2>Oberoi Mall FC MUM(169)</option><option value=3>MLY KFC KORUM MALL IT MUM(169)</option><option value=4>MLY KFC ORCHID CITY CNTR MA MUM(169)</option><option value=5>MLY KFC CHEMBUR IT MUM(169)</option><option value=6>YUM KFC Market City FC MUM(169)</option><option value=7> YUM KFC Infiniti Mall MUM(169)</option><option value=8>YUM Dy Patil MA MUM(149)</option><option value=9>Expresway Express(149)</option><option value=10>KFCH Vivia(149) </option><option value=11>Yum Growell M(149) </option><option value=12>KFCH Mira Rd(149) </option><option value=13> Kharagar(149)</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Chizza Bite</option><option value=2>Chizza Bite Meal</option></select></td></tr>
    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `CHICKI_25`( `q_id`,`resp_id`,`r_name`,mobile,`age_25`, `gender_25`, `sec_25`, `week_day_25`,`store_25`, `product_25`,`age_yrs_25`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
