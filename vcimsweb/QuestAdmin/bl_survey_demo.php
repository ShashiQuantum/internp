...
if($_GET['next']==3)
{
	...
	echo '<br>Your Survey has reset, Pls fill the survey from begning';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=-1&rsp=$resp_id";
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                          ...
                          $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=-1&rsp=$resp_id");
                	...
                	if($sh)
                        {
                            ...
                            {
                                if($h->qsec_id==$psec)
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#00e500;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                else
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
        ...
        */                
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr height=40><td></td><td colspan=2><textarea name=text$currq cols=150 rows=5 placeholder='type your response here'>$str</textarea> </td></tr>";                     
                        }else if($qt=='text')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                                if($rss)
                            ...
                            echo "<tr height=40><td></td><td colspan=2><input type=text name=text$currq size=60 placeholder='type your response here' value=$str> </td></tr>";                     
...
echo "</div>"; 
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }}}
                else
                {
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#004c00;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                    else
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
                            echo '</tr></table></center><br>';
                        }//end display tab
               */
                        ...
                        echo "<br><br><center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=-1&rsp=$resp_id'><input type='button' name='next' value='Recheck' style=background-color:#004c00;color:white;height:50px;></a> <input type='submit' name='submit' value='Submit Survey' style=background-color:#004c00;color:white;height:50px;></center>";
                }
               else 
                {
                    $ctr=0;
...
{
   echo "<tr height=40><td></td><td><textarea id=q$currq name=text$currq cols=60 rows=3 placeholder='type your response here'>$str</textarea>OR <img src='../../images/mic128.png' height=60 width=90 class='opener_pc'> </td></tr>";
}                                  
                        ...
                        }else if($qt=='text')
                        {
                            ...
                            echo "<tr height=40><td></td><td><input type=text id=q$currq name=text$currq size=60 placeholder='type your response here'  value=$str > </td></tr>";                     
                        }else if($qt=='textrating')
                        {
                            $rd=DB::getInstance()->query("SELECT distinct text_term, rating_term FROM `question_option_detail` WHERE `q_id`=$currq");
                            if($rd)
...
OR all_prod_exposed !=  '')");
  ...
  echo "<div id=footer>";
			echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey_demo.php?qset=$qset&next=1&rsp=$resp_id#'><input type='submit' name='save' value='Save & Next' onclick='return Validate();' style=background-color:#004c00;color:white;height:35px;></a> ";
...
$( ".opener" ).click(function() {  
    var page = "https://www.digiadmin.quantumcs.com/vcims/as.html";
