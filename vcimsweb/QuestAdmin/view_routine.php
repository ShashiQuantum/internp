...
<!DOCTYPE html>
<html>
<head><title>View Question Routine</title></head>
<body>
<center>
<br><br><h2>View Project's Questions Routine</h2><br><br>

<?php
	//create new question
	if(isset($_POST['routine_view']))
	{
	    //print_r($_POST);
	    	$pid=$_POST['pn'];
	    	$qset=$_POST['qset'];
		...
		{ 
		    ...
		    try { 
		     $conn = new PDO("mysql:host=localhost;dbname=vcims", 'root', 'Digiadmin');
...
?>
		...
		<table cellpadding="2" cellspacing="1" border="0" style="font-size:12px;">
                ...
                <tr><td>QuestionSet ID *</td><td><select name="qset" id="qset" ><option value="select">--Select--</option> </select> </td></tr>
               	<tr><td><input type=submit name=routine_view value=View></td></tr>
               	</form>
               	</table>
