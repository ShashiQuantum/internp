...
$url="http://wwww.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_7.php?qset=$qset";
...
<html>
    ...
    <center>
        <h1><font color="red">PROJECT - HOT</font></h1>
        <br>
        <table>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Banergatta HS -Bangalore</option><option value=2> Mantri Mall -Bangalore</option><option value=3>Lajpat Nagar -Delhi</option><option value=4>Saket -Delhi</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered_07"><option value=1>Sweet Chilli</option><option value=2> Peri Peri</option><option value=3>Seriously Spicy</option><option value=4>Sweet Chilli combo meal</option><option value=5>Peri Peri combo meal</option><option value=6>Seriously Spicy combo meal</option></select></td></tr>
    ...
    if(($fn!='') && ($mob!='') )
    {
        ...
        {       
            ...
            else if($da->first()->status==0 || $da->first()->status==1)
            {
                ...
                // DB::getInstance()->query("INSERT INTO `hot`( `q_id`,`resp_id`,`r_age_7`, `r_gender_7`, `r_sec_7`, `weekday_7`,`store_loc`, `product_ordered_07`,`r_age_yrs_7`,`r_name_7`,r_mobile_7) VALUES ($qset,$resp_id,'$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs','$fn','$mob')");
