        ...
        */                
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr><td></td><td colspan=2><textarea name=text$currq cols=150 rows=5 placeholder='type your response here'>$str</textarea></td></tr>";                     
                        }else if($qt=='text')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                                if($rss)
                            ...
                            echo "<tr><td></td><td colspan=2><input type=text name=text$currq size=60 placeholder='type your response here' value=$str></td></tr>";                     
...
echo "</div>";
                      ...
                      $qq="SELECT distinct `q_id`,`qset_id` FROM `question_routine_detail` WHERE `qset_id` = $qset and `qsec` in ($qsec) order by `q_id`"; 
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr><td></td><td><textarea name=text$currq cols=60 rows=3 placeholder='type your response here'>$str</textarea></td></tr>";                     
                        }else if($qt=='text')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                                if($rss)
                            ...
                            echo "<tr><td></td><td><input type=text name=text$currq size=60 placeholder='type your response here'  value=$str ></td></tr>";                     
                        }else if($qt=='textrating')
                        {
                            $rd=DB::getInstance()->query("SELECT distinct text_term, rating_term FROM `question_option_detail` WHERE `q_id`=$currq");
                            if($rd)
                        ...
                        else if($qt=='radio')
                        {
                            ...
                            {   
                                ...
                                echo "<tr><td></td><td width=2%><input type='$qt' class='xa' name=q$currq $str value='$op->value'></td><td> $op->opt_text_value</td></tr>";
                            }
                        }
                        else if($qt=='checkbox')
                        {   $j=0;
                   ...
                   echo "</table><br>";     }   //end of question type
                      ...
                      echo '<br><br>';           
  echo "<div id=footer>";
			echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id&&&see=0'><input type='submit' name='save' value='Save & Next' style='background-color:#004c00;color:white;height:35px;' onclick='return Validate();'></a> ";
                                //&nbsp  &nbsp <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/PrevDemoCSS.php?qset=$qset&next=1&rsp=$resp_id'><input type='button' name='next' value='Next'></a> </center>"; 
...
var error=0;
    ...
    if(radios[0].type=='radio' || radios[0].type=='checkbox')
    {
     ...
     if(radios[0].type=='text' || radios[0].type=='textarea')
    {
        for (var i = 0; i < radios.length; i++) 
        { 
           if (radios[i].value!='') 
