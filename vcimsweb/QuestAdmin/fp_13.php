...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Kalkaji -Delhi</option><option value=2>Sohna Road - Gurgoan</option><option value=3>KFC Nehru Place -Delhi</option><option value=4>KFC DT City Center MG Road Gurgaon - Gurgoan</option></select></td></tr>
    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( `full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ('$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `danube_13`( `q_id`,`resp_id`,`r_name_13`,mobile_13,`age_13`, `gen_13`, `sec_13`, `week_d_13`,`store_13`, `products_13`,`age_yrs_13`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
