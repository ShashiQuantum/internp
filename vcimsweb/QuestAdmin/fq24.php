...
?>
        ...
        <tr><td>Age<font color="red">*</font> </td><td><select name="age"><option value=1>21-24 yrs</option><option value=2>25-28 yrs</option> </select></td></tr>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Lajpat Nagar</option><option value=2>Dwarka</option><option value=3>Vasant Kunj Sun City</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Zinger burger, 2 chicken strip, 1 hashbrown, Pepsi, Dessert- PS1</option><option value=2>Zinger burger, 2 hotwings, 1 hashbrown, Pepsi, Dessert- MW2</option><option value=3>Rice and gravy, 1 hot & crispy chicken, 2 hotwings, Pepsi, Dessert- HC3</option><option value=4>Rice and gravy, 1 hot & crispy chicken, 1 chicken strip, Pepsi, Dessert- ST4</option></select></td></tr>
        <tr><td>Concept <font color="red">*</font> </td><td><select name="concept"><option value=1>Concept 1- PS1</option><option value=2>Concept 2- MW2 </option><option value=3>Concept 3- HC3 </option><option value=4>Concept 4- ST4 </option></select></td></tr>
...
//DB::getInstance()->query($sq);
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `SPARROW_24`( `q_id`,`resp_id`,`r_name`,mobile,`age_24`,  `week_day_24`,`store_24`, `product_24`,`age_yrs_24`,chml_24,khml_24,`concept_24`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$cat','$store','$ord_prod','$age_yrs','$chml','$khml','$concept')");
