...
?>
        ...
        <tr><td>Company Name  </td><td><input type="text" name="cmp" size="40"></td></tr>
        <tr><td>Designation  </td><td><input type="text" name="dsg" size="40"></td></tr>
    ...
    { 
        ...
        {       
            ...
            else if($da->first()->status==0 || $da->first()->status==1)
            {
                ...
                $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/dos.php";
              ...
              $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `ref_id`) VALUES ($qset,'$fn','$cmp','$email','$mob','$dsg')";
                ...
                DB::getInstance()->query("INSERT INTO $tablen( `q_id`,`resp_id`,`r_name`,mobile) VALUES ($qset,$resp_id,'$fn','$mob')");
