...
if(isset($_POST['submit']))
{
	...
	echo '<br>Thank You! Submitted';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_8.php?qset=$qset&yn=0";
        header('Location: '.$newURL);        
}
else    
{
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                          ...
                          $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=-1&rsp=$resp_id");
                	...
                	if($sh)
                        {
                            ...
                            {
                                if($h->qsec_id==$psec)
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#00e500;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                else
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
...
OR all_prod_exposed !=  '')");
   ...
   //         	}
                               echo '<br><br><br>';
		  echo "<div id=footer>";
					//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a> <a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a> <a href='?qset=$qset&next=1&rsp=$resp_id'><input type='submit' name='save' value='Save & Next' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id#'> <input type='submit' name='save' value='Save & Next' onclick='return Validate();' style='background-color:#004c00;color:white;height:35px;position:absolute; left:50%;'></a> </center> ";
...
echo "</div>"; 
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }}}
                else
                {
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#004c00;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                    else
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
                            echo '</tr></table></center><br>';
                        }//end display tab
               */
                        ...
                        echo "<br><br><center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=-1&rsp=$resp_id'><input type='button' name='next' value='Recheck' style=background-color:#004c00;color:white;height:50px;></a> <input type='submit' name='submit' value='Submit Survey' style=background-color:#004c00;color:white;height:50px;></center>";
                }
               else 
                {
                    $ctr=0;
...
OR all_prod_exposed !=  '')");
  ...
  echo "<div id=footer>";
			//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/sunflower_survey.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a>";
