...
if(isset($_POST['submit']))
{
	...
	echo '<br>Thank You! Submitted';
        //sleep(50);
        $newURL="https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/fp_bl.php?qset=$qset&yn=0";
        header('Location: '.$newURL);        
}
else
{
...
//start previous button==============================
            ...
            if($_SESSION['resp']!=$resp_id)
            {
                echo 'You have entered wrong URL, pls use your correct URL';
                          ...
                          $psec=$_SESSION['psec'];
                           if($psec==0)
                               header('Location: '."https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=-1&rsp=$resp_id");
                	...
                	if($sh)
                        {
                            ...
                            {
                                if($h->qsec_id==$psec)
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#00e500;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                else
                                    echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:30px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
        ...
        */                
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr height=40><td></td><td colspan=2><textarea name=text$currq cols=150 rows=5 placeholder='type your response here'>$str</textarea> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        }else if($qt=='text')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                                if($rss)
                            ...
                            echo "<tr height=40><td></td><td colspan=2><input type=text name=text$currq size=60 placeholder='type your response here' value=$str> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        }
                            else if($qt=='dropdown')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
                            ...
                            echo "<tr height=40><td></td><td><select id=q$currq name=text$currq> <option value=0>0</option><option value=1>1</option><option value=2>2</option><option value=3>3</option><option value=4>4</option><option value=5>5</option><option value=6>6</option><option value=7>7</option><option value=8>8</option><option value=9>9</option><option value=10>10</option><option value=11>11</option><option value=12>12</option><option value=13>13</option><option value=14>14</option><option value=15>15</option><option value=16>16</option><option value=17>17</option><option value=18>18</option><option value=19>19</option><option value=20>20</option><option value=21>>=21</option> </select></td></tr>";                     
                        }
...
OR all_prod_exposed !=  '')");
                            ...
                            {   
                                ...
                                if($lang==''||$lang=='none')
                                {
                                echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' id=q$currq name=q$currq $str value='$op->value'></td><td> $op->opt_text_value</td></tr>";
                                }
                                else if($lang=='hindi')
                                {
                                     ...
                                     {   
                                          ...
                                          echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' id=q$currq name=q$currq $str value='$v'></td><td>$eng_text  [ $h_text ]</td></tr>";
                                     }
                                      else  
                                      {
                                         echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' id=q$currq name=q$currq $str value='$op->value'></td><td> $op->opt_text_value</td></tr>";
                        ...
                        {   $j=0;
                            ...
                            {   $j++;
                                ...
                                if($lang==''||$lang=='none')
                                {
                                echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' name='$op->term$op->value' $str value='$op->value'></td><td> $op->opt_text_value </td></tr>";
                                }
                                else if($lang=='hindi')
                                {
                                     $rs33=DB::getInstance()->query("SELECT * FROM `hindi_question_option_detail` WHERE `op_id`=$opid ");
                                     ...
                                     {   
                                          $h_text=$rs33->first()->opt_text_value;
                                          echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' id=q$currq name='$op->term$op->value' $str value='$v'></td><td>$eng_text  [ $h_text ]</td></tr>";
                                     }
                                     else  
                                {
                                echo "<tr height=40><td></td><td width=2%><input type='$qt' class='xa' name='$op->term$op->value' $str value='$op->value'></td><td> $op->opt_text_value </td></tr>";
...
echo "</div>"; 
            ...
            echo "<br><br>";
                        ...
                        echo "<div id=footer>";
                                echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id'> <input type='button' name='next' value='Continue Survey' style=background-color:#004c00;color:white;height:35px;></a></center>"; 
                        echo "</div>";
                }}}
                else
                {
                ...
                {    
                    ...
                    {   //echo '<br>qid: '.$p->q_id;    
                                ...
                                //find the selected option by user from database
                                        ...
                                        if($qtd1->first()->q_type=='radio' || $qtd1->first()->q_type=='text' || $qtd1->first()->q_type=='checkbox'|| $qtd1->first()->q_type=='textarea' || $qtd1->first()->q_type=='checkbox' || $qtd1->first()->q_type=='calculated' || $qtd1->first()->q_type=='sec')
                                        if($qtd1->first()->q_type!='instruction' || $qtd1->first()->q_type!='top3rankcompany')
                                        {  
                                                //to find table and its column search
                                                $column='';$table='';
                	...
                	if($sh1->count()>0)
                        {
                            ...
                            {
                                if($h->qsec_id==$qsec)
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:#004c00;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";    
                                    else
                                echo "<td><a href=https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id&sec=".$h->qsec_id."><input type=button style=background-color:green;color:white;height:50px; name=".$h->sec_title." value='".$h->sec_title."'> </a></td>";
                            }
                            echo '</tr></table></center><br>';
                        }//end display tab
               */
                       ...
                       $qlist=array();$qid=0;
                        ...
                        if($qt=='rating')
                        {
                            ...
                            if($da->count()>0)
                            {
                                ...
                                $arr_temp=array();$str='';
                                            ...
                                            $column='';$table='';$arr_column=array();$arr_table=array();$vv='';
                                            $sq="SELECT distinct `rating_term` FROM `question_option_detail` WHERE `q_id`=$currq ";
                                            $rd=DB::getInstance()->query($sq);
                                            if($rd)
                                            {
                                                $column=$rd->first()->rating_term;
                                                array_push($arr_column,$column);
                                                $tbf="SELECT DISTINCT TABLE_NAME,COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE COLUMN_NAME IN ('$column') ";
                                                $tbf1=DB::getInstance()->query($tbf);
                                                if($tbf1)
                                ...
                                if($sv==0)
                                {
                                    ...
                                    {   
                                        ...
                                        echo "<td width=45><input type=radio name=r$currq $str value=$s> </td>";
                                    }
                                    echo "<td> $el </td><td ><input type=radio name=r$currq value=$s></td></tr></table>";                                
                                }else if($sv==1)
                                {
                                    echo "<table border=1><tr height=40><td> </td>";
                                    for($s=$sv;$s<=$ev;$s++)
                                    {
                                        echo "<td> $s </td>";
                                    }
                        ...
                        else if($qt=='textarea')
                        {
                            ...
                            //to find table and its column search
                                ...
                                echo "<tr height=40><td></td><td><textarea id=q$currq name=text$currq cols=60 rows=3 placeholder='type your response here'>$str</textarea> OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td> </tr>";
                        ...
                        }else if($qt=='text')
                        {
                            ...
                            echo "<tr height=40><td></td><td><input type=text id=q$currq name=text$currq size=60 placeholder='type your response here'  value=$str > OR <img src='../../images/mic128.png' height=60 width=90 class='opener'></td></tr>";                     
                        }
                            else if($qt=='dropdown')
                        {
                                $rss=DB::getInstance()->query("SELECT * FROM `question_option_detail` WHERE `q_id`=$currq ");
...
OR all_prod_exposed !=  '')");
  ...
  echo "<div id=footer>";
			//echo "<center><a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=3&rsp=$resp_id'><input type='button' name='reset_survey' value='Reset Survey' style=background-color:#004c00;color:white;height:35px;></a>";

 echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=2&rsp=$resp_id'><input type='button' name='prev' value='Previous' style=background-color:#004c00;color:white;height:35px;></a>";

echo "<a href='https://www.digiadmin.quantumcs.com/vcims/QuestAdmin/bl_survey.php?qset=$qset&next=1&rsp=$resp_id#'> <input type='submit' name='save' value='Save & Next' onclick='return Validate();' style='background-color:#004c00;color:white;height:35px;position:absolute; left:50%;'></a> </center> ";
