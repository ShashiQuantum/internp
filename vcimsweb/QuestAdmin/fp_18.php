...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Bel Road</option><option value=2>Forum Mall</option><option value=3>Signature Mall</option><option value=4>Market City FC </option> <option value=5>Cyber Hub Gurgaon</option><option value=6>Ambience Mall Gurgaon</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Rice Meal Box</option></select></td></tr>
    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( qset_id,`full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ($qset,'$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `YUMMY_18`( `q_id`,`resp_id`,`r_name`,mobile,`age_18`, `gender_18`, `sec_18`, `week_day_18`,`store_18`, `product_18`,`age_yrs_18`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
