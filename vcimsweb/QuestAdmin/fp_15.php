...
?>
        ...
        <tr><td>Interview day<font color="red">*</font> </td><td><select name="category"><option value=1>Monday</option><option value=2>Tuesday</option><option value=3>Wednesday</option><option value=4>Thursday</option><option value=5>Friday</option><option value=6>Saturday</option><option value=7>Sunday</option> </select></td></tr>
         <tr><td>Store Location <font color="red">*</font> </td><td><select name="store"><option value=1>Preet Vihar -Delhi</option><option value=2>Sun City Vasant Kunj - Delhi</option></select></td></tr>
         
        <tr><td>Product Ordered <font color="red">*</font> </td><td><select name="product_ordered"><option value=1>Peri Peri Popcorn Shakers with Pepsi and Hot & Crispy/Fiery Grilled Chicken</option><option value=2>Peri Peri Popcorn shaker with Pepsi and Zinger Burger</option><option value=3>Peri Peri Popcorn shaker with 2 Pepsi and Mingles Bucket</option>  <option value=4>Seriously Spicy Popcorn Shakers with Pepsi and Hot & Crispy/Fiery Grilled Chicken</option><option value=5>Seriously Spicy Popcorn shaker with Pepsi and Zinger Burger</option><option value=6>Seriously Spicy Popcorn shaker with 2 Pepsi and Mingles Bucket</option><option value=7>Sweet Chilli Popcorn Shakers with Pepsi and Hot & Crispy/Fiery Grilled Chicken</option><option value=8>Sweet Chilli Popcorn shaker with Pepsi and Zinger Burger</option><option value=9>Sweet Chilli Popcorn shaker with 2 Pepsi and Mingles Bucket</option></select></td></tr>
    ...
    { 
        ...
        {       
           ...
           $sql21="INSERT INTO `demo_respondent`( `full_name`, `address`, `email`, `mobile`, `mac_email`, `ref_id`, `cntr_id`) VALUES ('$fn','$add','$email','$mob','$mac_email','$ref','$cn')";
                ...
                DB::getInstance()->query("INSERT INTO `scarlet_15`( `q_id`,`resp_id`,`r_name`,mobile,`age_15`, `gender_15`, `sec_15`, `week_day_15`,`store_15`, `product_15`,`age_yrs`) VALUES ($qset,$resp_id,'$fn','$mob','$age','$gen','$sec','$cat','$store','$ord_prod','$age_yrs')");
