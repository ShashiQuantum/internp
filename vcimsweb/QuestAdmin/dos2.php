       ...
       {       
        ...
        if($sid>=0 && $sid<=$maxsid)
        {
             ...
             {   //echo "<br>bf sid:$sid";
                 ...
                 if($sid!=1 || $sid!=2 ||$sid!=3 || $sid!=4 || $sid==5 || $sid==6 || $sid==7 || $sid==8 || $sid==9 || $sid==10 || $sid==11 || $sid==12 || $sid==13 || $sid==14 || $sid==15 || $sid==16 || $sid==17 || $sid==18  || $sid==19 || $sid==20 || $sid==21 || $sid==22   )
                 {
     ...
     {       
        ...
        //print_r($opt_arr);                     
             ...
             {   
                ...
                if($sid!=2 || $sid!=3 || $sid!=4 || $sid!=5 ||$sid!=6 || $sid!=7 || $sid!=8 || $sid!=9 || $sid!=10 || $sid!=11 || $sid!=12 || $sid!=13 || $sid!=14 || $sid!=15 || $sid!=16 || $sid!=17 || $sid!=18 || $sid!=19 || $sid!=20 || $sid!=21 || $sid!=22 || $sid!=23)
                {
                  //array_push($qlist,$qid);
              	  save_result($_POST,$table,$qset,$resp_id);
...
?> 
	...
	var error=0; var qid=jArray[0];
	    ...
	    {   var flag=0;
	        var ctr=0;
	        var elm=jArray[j]; 
	        var qq='q'+elm; var nm='text'+elm;  //alert(qq);
	...
	table{ border-style:show; border: none;}
