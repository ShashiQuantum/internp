...
<html>
<br><br><center>
	<h3>PROJECT SHOW CARD</h3><br<br>	
               	<form action="1249.php" method="post" enctype="multipart/form-data" target="_blank">
                ...
                <tr><td>QuestionSet ID *</td><td><select name="qset" id="qset" onclick="display();"><option value="select">--Select--</option> </select> </td></tr>
		<tr><td>Translated Language:</td><td> <select name=tl id=tl><option value=0> English </option> <option value=1> Hindi </option> <option value=2> Kannad </option> <option value=3> Malyalam </option><option value=4>Tammil</option><option value=5>Telgu</option><option value=6>Bangla</option><option value=7>Odia</option><option value=8>Gujrati</option><option value=9>Marathi</option><option value=10>Asami</option> </select> </td></tr>
             	<tr><td>Question ID </td><td> <select name="qid" id="qid"> <option value="0">--Select--</option></select> </td></tr>
               	<tr><td></td><td><input type=submit name=sc_view value="VIEW SHOWCARD"></td></tr>
                </table>
               	</form>
