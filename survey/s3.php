...
<tr style="background-color:white;"><td style="height:3%;width:100%;">
     <div> <!--
                        ...
                        <span style=float:left;><img src='https://vareniacims.com/public/img/logos/varenia_logow.png' height=40px width=100px> </span>
	--> 
    </div>
</td></tr>
...
//print_r($arr_temp);
		...
		*/
			...
			if(in_array('14105',$gqids))
			{
					...
					*/
					...
					foreach($arr_qo_val as $ov){
						...
						<input type='text' id='os' class='os' name='q14216' placeholder='Specify here' style='display:none; margin-left:25px'>	
							...
							echo "<td style='background-color:lightgray'><input type='radio' class='big' id=q$qid name=q$qid $str value=$ov> $opt ";
							
							echo "<input type=hidden name='qid[]'  value= 14106 >";
							if($qid==14105 and $i==3)
							{
								echo "<input type='text' id='osubj' class='osubj' name='q14106' placeholder='Specify here' style='display:none; margin-left:25px'>";
							}
							echo "</td>";
					...
					*/
					...
					foreach($arr_qo_val as $ov)
					{
						...
						echo "<select style='margin-left:25px;' name='q14134' id='sel1a' onchange='sel1_a(this.value)'>";
						...
						echo "<input type='text' id='1ao' name='Q14135' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14136'>";
						echo "<select style='margin-left:25px;' name='q14136' id='sel1b' onchange='sel1_b(this.value)'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='1bo' name='q14137' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14138'>";
						echo "<select style='margin-left:25px;' name='q14138' id='sel1c' onchange='sel1_c(this.value)'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='1co' name='q14139' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14140' onchange='sel2_a(this.value)' id='sel2a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='2ao' name='q14141' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14142'>";
						echo "<select style='margin-left:25px;' name='q14142' onchange='sel2_b(this.value)' id='sel2b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='2bo' name='q14143' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14144'>";
						echo "<select style='margin-left:25px;' name='q14144' onchange='sel2_c(this.value)' id='sel2c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='2co' name='q14145' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14146' onchange='sel4_a(this.value)' id='sel4a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='4ao' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<select style='margin-left:25px;' name='q14148' onchange='sel4_b(this.value)' id='sel4b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='4bo' name='q14149' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14150'>";
						echo "<select style='margin-left:25px;' name='q14150' onchange='sel4_c(this.value)' id='sel4c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='4co' name='q14151' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14152' onchange='sel9_a(this.value)' id='sel9a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='9ao' name='q14153' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14154'>";
						echo "<select style='margin-left:25px;' name='q14154' onchange='sel9_b(this.value)' id='sel9b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='9bo' name='q14155' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14156'>";
						echo "<select style='margin-left:25px;' name='q14156' onchange='sel9_c(this.value)' id='sel9c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='9co' name='q14157' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14158' onchange='sel14_a(this.value)' id='sel14a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='14ao' name='q14159' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14160'>";
						echo "<select style='margin-left:25px;' name='q14160' onchange='sel14_b(this.value)' id='sel14b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='14bo' name='q14161' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14162'>";
						echo "<select style='margin-left:25px;' name='q14162' onchange='sel14_c(this.value)' id='sel14c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='14co' name='q14163' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14164' onchange='sel15_a(this.value)' id='sel15a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='15ao' name='q14165' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14166'>";
						echo "<select style='margin-left:25px;' name='q14166' onchange='sel15_b(this.value)' id='sel15b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='15bo' name='q14167' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14168'>";
						echo "<select style='margin-left:25px;' name='q14168' onchange='sel15_c(this.value)' id='sel15c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='15co' name='q14169' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14170' onchange='sel16_a(this.value)' id='sel16a'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='16ao' name='q14171' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14172'>";
						echo "<select style='margin-left:25px;' name='q14172' onchange='sel16_b(this.value)' id='sel16b'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='16bo' name='q14173' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14174'>";
						echo "<select style='margin-left:25px;' name='q14174' onchange='sel16_c(this.value)' id='sel16c'>";
						echo "<option value='' disabled selected>--Please Select--</option>";
						...
						echo "<input type='text' id='16co' name='q14175' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14176' onchange='sel17_a(this.value)' id='sel17a'>";
						echo "<option value='' selected disabled>Select for BBA</option>";
						...
						echo "<input type='text' id='17ao' name='q14177' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14178'>";
						echo "<select style='margin-left:25px;' name='q14178' onchange='sel17_b(this.value)' id='sel17b'>";
						echo "<option value='' selected disabled>Select for BBA</option>";
						...
						echo "<input type='text' id='17bo' name='q14179' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14180'>";
						echo "<select style='margin-left:25px;' name='q14180' onchange='sel17_c(this.value)' id='sel17c'>";
						echo "<option value='' selected disabled>Select for BBA</option>";
						...
						echo "<input type='text' id='17co' name='q14181' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14182' onchange='sel17_d(this.value)' id='sel17d'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='17do' name='q14183' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//5th choice
						echo "<input type=hidden name='qid[]' value='14184'>";
						echo "<select style='margin-left:25px;' name='q14184' onchange='sel17_e(this.value)' id='sel17e'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='17eo' name='q14185' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 6th choice
						echo "<input type=hidden name='qid[]' value='14186'>";
						echo "<select style='margin-left:25px;' name='q14186' onchange='sel17_f(this.value)' id='sel17f'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='17fo' name='q14187' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14188' onchange='sel18_a(this.value)' id='sel18a'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='18ao' name='q14189' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14190'>";
						echo "<select style='margin-left:25px;' name='q14190' onchange='sel18_b(this.value)' id='sel18b'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='18bo' name='q14191' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14192'>";
						echo "<select style='margin-left:25px;' name='q14192' onchange='sel18_c(this.value)' id='sel18c'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='18co' name='q14193' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14194' onchange='sel18_d(this.value)' id='sel18d'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='18do' name='q14195' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 5th choice
						echo "<input type=hidden name='qid[]' value='14196'>";
						echo "<select style='margin-left:25px;' name='q14196' onchange='sel18_e(this.value)' id='sel18e'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='18eo' name='q14197' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 6th choice
						echo "<input type=hidden name='qid[]' value='14198'>";
						echo "<select style='margin-left:25px;' name='q14198' onchange='sel18_f(this.value)' id='sel18f'>";
						echo "<option value='' selected disabled>Select for MBA</option>";
						...
						echo "<input type='text' id='18fo' name='q14199' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14200' onchange='sel19_a(this.value)' id='sel19a'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='19ao' name='q14201' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						//2nd choice
						echo "<input type=hidden name='qid[]' value='14202'>";
						echo "<select style='margin-left:25px;' name='q14202' onchange='sel19_b(this.value)' id='sel19b'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='19bo' name='q14203' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 3rd choice
						echo "<input type=hidden name='qid[]' value='14204'>";
						echo "<select style='margin-left:25px;' name='q14204' onchange='sel19_c(this.value)' id='sel19c'>";
						echo "<option value='' selected disabled>Select for Btch</option>";
						...
						echo "<input type='text' id='19co' name='q14205' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<select style='margin-left:25px;' name='q14206' onchange='sel19_d(this.value)' id='sel19d'>";
						echo "<option value='' selected disabled>Select for MTech</option>";
						...
						echo "<input type='text' id='19do' name='q14207' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 5th choice
						echo "<input type=hidden name='qid[]' value='14208'>";
						echo "<select style='margin-left:25px;' name='q14208' onchange='sel19_e(this.value)' id='sel19e'>";
						echo "<option value='' selected disabled>Select for MTech</option>";
						...
						echo "<input type='text' id='19eo' name='q14209' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						
						// 6th choice
						echo "<input type=hidden name='qid[]' value='14210'>";
						echo "<select style='margin-left:25px;' name='q14210' onchange='sel19_f(this.value)' id='sel19f'>";
						echo "<option value='' selected disabled>Select for MTech</option>";
						...
						echo "<input type='text' id='19fo' name='q14211' placeholder='Specify Other Course' style='display:none; margin-left:10px'>";
						...
						echo "<input type='text' id='sel20a' name='q14212' placeholder='Specify Other Course 1' style='margin-left:10px'>";
						
						// 2nd	
						echo "<input type=hidden name='qid[]' value='14213'>";	
						echo "<input type='text' id='sel20b' name='q14213' placeholder='Specify Other Course 2' style='margin-left:10px'>";
						
						// 3rd
						echo "<input type=hidden name='qid[]' value='14214'>";
						echo "<input type='text' id='sel20c' name='q14214' placeholder='Specify Other Course 3' style='margin-left:10px'>";		
                   ...
                   echo "</table>";
							...
							//1st college details
							echo "<table style='width:100%'><td colspan=2> Please specify your top 3 colleges and locations in below grid. </td>";
							echo "<tr><td>Your 1st Choice</td>";
							echo "<td style='background-color:lightgray'>";
                            echo "<input type=hidden name='qid[]' value='14113'>";
							echo "<input type='text' id=q14113 name=q14113 style='width:50%' placeholder='Enter College Name1' required>"; 
							
							echo "<br>";
							echo "<br>";
							
							echo "<span style='font-size:20px'>College1 City:</span>";
							...
							echo "<input type='text' name='q14115' class='collegeOtherCity1' id='collegeOtherCity1_6' style='margin-left:25px; display:none' placeholder='Specify Other City'>";
							...
							//2nd college details
							echo "<tr> <td>Your 2nd Choice</td>";
							echo "<td style='background-color:lightgray'>";
	                        echo "<input type=hidden name='qid[]' value='14216'>";
							echo "<input type='text' id='q14216' style='width:50%' name=q14216 placeholder='Enter College Name 2' required>"; 
							
							echo "<br>";
							echo "<br>";
							
							echo "<span style='font-size:20px'>College2 City:</span>";
							...
							echo "<input type='text' style='margin-left:25px; display:none' name='q14118' class='collegeOtherCity2' id='collegeOtherCity2_6' placeholder='Specify Other City'>";
							...
							//3rd college details
							echo "<tr><td>Your 3rd Choice</td>";
							echo "<td style='background-color:lightgray'>";
	                        echo "<input type=hidden name='qid[]' value='14119'>";
							echo "<input type='text' style='width:50%' id=q14119 name=q14119 $str placeholder='Enter College Name 3' required>"; 
							
							echo "<br>";
							echo "<br>";
							
							echo "<span style='font-size:20px'>College3 City:</span>";
							...
							echo "<input type='text' name='q14121' class='collegeOtherCity3' name='q14121' id='collegeOtherCity3_6' style='margin-left:25px; display:none' placeholder='Specify Other City'>";
		...
		// ************************ residence cities *******************//
						...
						{
							//current city
							echo "<table style='width:100%'><td colspan=2 style='color:skyblue'> Kindly provide the address of your current residence. </td>";
									
							$ccity = get_qop(14219, 'opt_text_value');
							$c1=0;
							echo "<tr style='background-color:lightgray'>";
							echo "<input type=hidden name='qid[]' value='14218'>";
							echo "<td></td><td>Full Address: <input type='text' name='q14218' placeholder='Enter Your Current Address' style='width:50%'>";
							echo "<br>";
							echo "<br>";
							echo "City:";
							...
							echo "<input type='text' name='q14220' style='margin-left:25px; display:none' id='ocity3' class='ocity3' placeholder='Specify Other City'>";
						 ...
						 //permanent city
							echo "<table style='width:100%'><td colspan=2 style='color:skyblue'> Kindly provide the address of your Permanent residence. </td>";
									
							$ccity = get_qop(14222, 'opt_text_value');
							$c1=0;
							echo "<tr style='background-color:lightgray'>";
							echo "<input type=hidden name='qid[]' value='14221'>";
							echo "<td></td><td>Full Address: <input type='text' name='q14221' placeholder='Enter Your Permanent Address' style='width:50%'>";
							echo "<br>";
							echo "<br>";
							echo "City:";
							foreach($ccity as $cl1)
							...
							echo "<input type='text' name='q14223' style='margin-left:25px; display:none' id='opcity3' class='opcity' placeholder='Specify Other City'>";
		...
		$get_db_t=get_qop(14217, 'opt_text_value'); //dob question
								  ...
								  {   $str=''; 
									...
									*/
									...
									if($lang == 'none')
									{
										...
										{
											echo "<input type='text' id='sch_input8' name='q14104' class='sch' placeholder='Plase Specify Other' style='display:none; margin-left:25px'>";
										}
										
										//outside india textarea
										if($qid==14110 and $value==2)
										{
											echo "<input type='text' id='outInd2' name='q14111' class='outInd' placeholder='Plase Specify Other' style='display:none; margin-left:25px'>";
										}
						...
						*/
							...
							{  	echo "<table><input type=hidden name='qid[]' value=$qid>";
								...
								{     $str='';
									...
									{
										$aa='q'.$qid.'[]'; //$aa='q'.$qid.'[]';
									 	echo "<tr height=40><td></td><td width=2%><input type='$qtype' class='big' id=q$qid name='$aa' $str value='$value'></td>
										<td style='border-bottom: 1px solid #ff;'> $opt 
\										<hr> </td></tr>";
									}
									else if($lang == '1')
									{
	...
	<br><font size=2 color=red><div id=err></div></font>       
      ...
      <?php } ?>
	   ...
	   <input type='submit' id='btn' name='next' value="Next" class="next" onclick='return Validate();' style='background-color:#004c00;color:white;height:35px; margin-left:50%; float:center; padding: 8px 16px;display: inline-block;'><br><br>
		 ...
		 <span style='color:red; font-size:16px;' id='showError'></span></center>  
	  <?php } ?>
	  </center>  
...
// radio validation
	...
	if(qlist.some(item => item == '14103') && qlist.some(item => item == '14105') && qlist.some(item => item != '14109'))
	{
		...
		if(checked_14103>0 && checked_14105>0)
		{
			return true;
		}
	...
	if(qlist.some(item => item == '14126') && qlist.some(item => item == '14131'))
	{
		...
		if(checked_14131==0 && text_14126=='' && text_14127=='')
		{
			alert('Not Allowed');
			return false;
		}
...
$(document).ready(function() 
{
    $("input[name$='q14219']").click(function()
	{
		...
		if(test==3)
		{
			document.getElementById("ocity3").required=true;
		}
		
		else
		{
			document.getElementById("ocity3").required=false;
...
$(document).ready(function() 
{
    $("input[name$='q14105']").click(function()
	{
		...
		if(test2 == 4)
		{
			document.getElementById('osubj').style.display="block";
...
$(document).ready(function() {
    $("input[name$='q14109']").click(function()
	{
		...
		if(test==1) 
		{
			...
			document.getElementById("sel1b").required=true;
			document.getElementById("sel1c").required=true;
