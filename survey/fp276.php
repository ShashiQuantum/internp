...
<tr><td style="background-color: #fff; color: #094041;" align="center"> Your inputs are invaluable and will help us to improve  products and services.<br> We truly appreciate your time and feedback. </td></tr>
...
<?php
	if($fpid == 1){
?>
        <tr > <td class="tbl_dcolor" style="width: 50%;"> City Name <font color="red">*</font> </td><td class="tbl_lcolor"><input type="text" name="fname" placeholder="Enter your city name" size="60" required></td></tr>
	 	...
	 	$sql21="INSERT INTO respondent_web ( qset,`r_name`,`mobile`,starttime, status) VALUES ($qset,'$fn','$mob', '$dt', 1)";
			...
			echo $sqt = "INSERT INTO $table ( `q_id`,`resp_id`, st , $fpt ) VALUES ($qset,$resp_id,0, '$fpv')";
                	$ds = DB::getInstance()->query($sqt);
                     	...
                     	$newURL="http://localhost/quantumdigiadmin/survey/fpn276.php?resp=$resp_id&lang=$lang&qset=$qset&sid=0&table=$table&maxsid=$maxsid";
