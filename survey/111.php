...
$qset=$_GET['qset'];
$url="http://wwww.vareniacims.com/test/111.php?qset=$qset";
date_default_timezone_set("Asia/Kolkata");
?>
<html>
    <body>
     <div id=header>
                            <p style=float:right><img src='http://vareniacims.com/public/img/logos/varenia_logow.png' height=50 width=150> </p><br><br><br><br>
     </div> 
    <center>
<?php
//$qset=$_SESSION['pid'];
...
?>
      ...
      <?php 
        ...
        <tr><td>Prefered Language: </td><td><select name=lang><option value='none'>English </option><option value="1">Hindi - English</option></select> </td></tr>
...
if(isset($_POST['subinfo']))
{
    ...
    { 
        ...
        if($da->count()>0)
        {
			...
			$newURL="http://www.vareniacims.com/test/222.php?next=-1";
