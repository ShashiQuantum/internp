...
if(isset($_POST['subinfo']))
{
	...
	if( ($centre == '-1') && ($city == '') ){
		...
		if($city=='') $city='NA';
			...
			echo $sqt = "INSERT INTO $table ( `q_id`,`resp_id`,`age`,`gender`, edu,occup,centre,city,st) VALUES 
			($qset,$resp_id,'$age','$gen',$edu, $occ,$centre,'$city',0)";
                	$ds = DB::getInstance()->query($sqt);
			//$newURL="http://www.vareniacims.com/test/21.php";
                     	$newURL="http://www.vareniacims.com/test/msurvey.php";
