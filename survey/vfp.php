...
<?php
	if($fpid == 1){
?>
        <tr > <td class="tbl_dcolor" style="width: 50%;">Name <font color="red">*</font> </td><td class="tbl_lcolor"><input type="text" name="fname" placeholder="Enter your name here" size="40" required></td></tr>
...
<?php
        ...
        if($fpid == 9 || $fpid ==10){
?>
        <tr><td class="tbl_dcolor">SEC<font color="red">*</font> </td><td class="tbl_lcolor"><select name="sec" required><option value=''>Select SEC</option>
<?php
...
<?php
        ...
        if($fpid == 11){
?>
	<tr><td class="tbl_dcolor">Store<font color="red">*</font> </td><td class="tbl_lcolor"><select name="store" required><option value=''>Select Store</option>
...
?>
	<!--
        <tr><td class="tbl_dcolor">Preferred Language </td><td class="tbl_lcolor"><select name=lang ><option value='none'>English Only</option><option value=1>Hindi-English</option></select> </td></tr>
	-->
        <tr><td></td><td><br><input type="submit" name="subinfo" value="Start Survey" style="background-color:#004c00;color:white;height:30px;"></td></tr>
