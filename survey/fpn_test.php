				...
				if($arr_qt[1] == 'dropdown'){
				  ...
				  // ========================================= // ======================================================================================================================================================= //		  
					...
					foreach($arr_qo_val as $ov){
						...
						echo "<td style='background-color:lightgray'><input type='radio' class='big r_$qid$rd' id=q$qid name=q$qid $str value=$ov></td>";
					}
					echo "</tr>";
                                  }
                                    echo "</table>";
						...
						$aa='q'.$qid.'[]';
                                                echo "<td style='background-color:lightgray'><input type='checkbox' class='big' id=q$qid name=$aa $str value=$ov></td>";
                                        }
                                        echo "</tr>";
                                  }
                                    echo "</table>";
				...
				{ 
					...
					$qimg=$ques->first()->image;
							...
							//end of find replace rule
							 ...
							 echo "<p style='font-size:10px;'> $qno </p> <p>$qtitle</p><font color=red><span id='$error'></span></font></div>";
