...
include_once('survey-function2.php');
...
<tr style="background-color:white;"><td style="height:3%;width:100%;">
	...
	if(isset($_POST['submit']))
	{
                    ...
                    //session_destroy();
                       ...
                       echo $newURL="http://www.vareniacims.com/test/1.php?q=$qset";
...
//	echo "<br>b sid: $ps , sptr: $sptr";
		...
		if($sid>=0 && $sid<=$maxsid)
		{
			$sptr = 1; $nptr = 2;$cqid=0;$cqid_arr_cnt = 0;
				if($sid==0)
				{
						$sptr = 1;
						$_SESSION['sptr']=$sptr;
				...
				else
				{
					 if(isset($_POST['next'])){
						...
						$_SESSION['sptr']=$_SESSION['sid'];
                                         ...
                                         if(isset($_POST['back'])){
                                                $sptr = 1 ;
						if(count($_SESSION['pqstack'])>0) $sptr = $sid +1;
						$eptr=$sptr+$nptr;
						$_SESSION['sptr']=$sid;
                                         }
					...
					$cqid_arr_cnt = count($cqid_arr);
		//echo " c before: sptr: $sptr, eptr: $eptr , cnt: $cqid_arr_cnt, sid: $sid ;";
					if($cqid_arr_cnt == 1){
						//--$sid;
					...
					foreach($dd as $di){
					    ...
					    if(count($dd)>1)
                                            if($iqid == 12674){
                                             ...
                                             if($iqid == 12679){
						$arr_pq=array(12680,12681,12682,12683); break;
                                     ...
                                     if($qset == 217){
                                        $dd = get_q_response($table,$resp_id,12560);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12564){
                                                if( $di == 1){$q=12565; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12566; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12567; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12568; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12605){
						$arr_pq=array(12606,1207,12608,12609); break;
                                                //if( $di == 1){$q=12606; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12607; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12608; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12609; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
                                     if($qset == 218){
                                        $dd = get_q_response($table,$resp_id,12611);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12615){
                                                if( $di == 1){$q=12616; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12617; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12618; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12619; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12620){
						$arr_pq=array(12621,12622,12623,12624); break;
                                                //if( $di == 1){$q=12621; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12622; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12623; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12624; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
                                     if($qset == 220){
                                        $dd = get_q_response($table,$resp_id,12722);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12726){
                                                if( $di == 1){$q=12727; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12728; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12729; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12730; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12731){
						$arr_pq=array(12732,12736,12737,12738); break;
                                                //if( $di == 1){$q=12732; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12736; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12737; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12738; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
                                     if($qset == 221){
                                        $dd = get_q_response($table,$resp_id,12786);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12790){
                                                if( $di == 1){$q=12791; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12792; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12793; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12794; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12795){
						$arr_pq=array(12796,12797,12798,12799); break;
                                                //if( $di == 1){$q=12796; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12797; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12798; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12799; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset

                                     if($qset == 222){
                                        $dd = get_q_response($table,$resp_id,12844);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12856){
                                                if( $di == 1){$q=12858; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12860; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12862; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12864; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12867){
						$arr_pq=array(12869,12870,12872,12875); break;
                                                //if( $di == 1){$q=12869; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12870; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12872; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12875; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
                                     if($qset == 223){
                                        $dd = get_q_response($table,$resp_id,12855);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12871){
                                                if( $di == 1){$q=12874; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12876; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12965; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12966; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12877){
						$arr_pq=array(12878,12879,12968,12969); break;
                                                //if( $di == 1){$q=12878; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12879; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12968; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12969; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
                                     if($qset == 224){
                                        $dd = get_q_response($table,$resp_id,12863);
                                        //print_r($dd);
                                        $arr_pq=array();
                                        foreach($dd as $di){
                                            if(count($dd)>1)
                                            if($iqid == 12880){
                                                if( $di == 1){$q=12881; array_push($arr_pq,$q);}
                                                if( $di == 2){$q=12882; array_push($arr_pq,$q);}
                                                if( $di == 3){$q=12884; array_push($arr_pq,$q);}
                                                if( $di == 4){$q=12886; array_push($arr_pq,$q);}
                                             }
                                             if($iqid == 12888){
						$arr_pq=array(12889,12890,12893,12894); break;
                                                //if( $di == 1){$q=12889; array_push($arr_pq,$q);}
                                                //if( $di == 2){$q=12890; array_push($arr_pq,$q);}
                                                //if( $di == 3){$q=12893; array_push($arr_pq,$q);}
                                                //if( $di == 4){$q=12894; array_push($arr_pq,$q);}
                                             }
                                        }
                                     } //end of if qset
...
?> 
	...
	<br><font size=2 color=red><div id=err></div></font>       
       ...
       <?php $arr=$_SESSION['pqstack']; if( count($arr) > 0){  ?>
...
$(document).ready(function () 
{
    ...
    $('#btn').click(function() 
	{
	  ...
	  var cid=document.getElementById('q12326');
	  var rid=document.getElementById('q12327');
          var cid=document.getElementById('q12562');
          var rid=document.getElementById('q12563');
	  var cid=document.getElementById('q12613');
          var rid=document.getElementById('q12614');

          var cid=document.getElementById('q12672');
          var rid=document.getElementById('q12673');
          var cid=document.getElementById('q12724');
          var rid=document.getElementById('q12725');

          var cid=document.getElementById('q12788');
          var rid=document.getElementById('q12789');
          var cid=document.getElementById('q12846');
          var rid=document.getElementById('q12852');

          var cid=document.getElementById('q12861');
          var rid=document.getElementById('q12865');
          var cid=document.getElementById('q12868');
          var rid=document.getElementById('q12873');
