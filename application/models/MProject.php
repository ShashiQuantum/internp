...
<input class='form-control' type=number id=ssid name=ssid value='1' placeholder='start sid' required> <br>To SID <input class='form-control' type=number id=esid name=esid value=1 placeholder='end sid' required> <br> Step value:<input class='form-control' type=number id=num name=num value=1 placeholder='enter step value' required> <br><br><input class='btn btn-primary' type=submit value='Update-Increase' name='submit'> <input class='btn btn-primary' type=submit value='Update-Decrease' name='submit'>";
	        ...
	        public function getcreateproject()
	        {
					...
					$str.="<tr id='surve_occurance' style='display: none'><td> Survey Occurrence <span style='color: red'>*</span> </td><td><select name='survey_occurrence' id='survey_occurrence' class='form-control' style='display: none'> <option value='everyday'>Every Days</option>  </select></td></tr>";
					$str.="<tr id='surve_time' style='display: none'><td> Survey Frequencies <span style='color: red'>*</span> </td><td><select name='survey_times' id='survey_times' class='form-control' style='display: none'> <option value='1'>Single Times</option>  <option value='2'>Two times</option> <option value='3'>Three times</option> <option value='4'>Four times</option> <option value='5'>Five times</option><option value='6'>Six times</option><option value='7'>Seven times</option><option value='8'>Eight times</option><option value='9'>Nine times</option><option value='10'>Ten times</option></select></td></tr>";
