...
<div id=oplist style='display:none;'> Total Options<input type=number class='form-control' name=cnt id=cnt style='width:70px;' onchange='generate();'> </div> <a href='https://digiadmin.quantumcs.com/quantumdigiadmin/siteadmin/user_action/createquestion'> RESET ALL</a> </td></tr>";
