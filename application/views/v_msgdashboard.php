...
<div class="row container">
    ...
    <script>
        ...
        function showques(){
			...
			if(i == 1){
                    sstt += '<div> <span class="badge badge-dark"> Q-'+i+'. </span><br> <span class="badge badge-dark"><input type="hidden" style="width:135px;" min=1 id="seq'+i+'" value="'+i+'" >  <input type="hidden" id="pqid'+i+'" placeholder="qids ex 2,3">   <input type="text" id="tv'+i+'" placeholder="Ex. hi,yes,hello"> Match Type <select id="mt'+i+'"><option value="2">Multiple Choice</option><option value="1">Signle Choice</option> </select> <br> Then reply as <textarea rows="3" cols="80" id="msg'+i+'" placeholder="Question here "></textarea> <textarea rows="3"  id="op'+i+'"  placeholder="Options like 1,2" onChange="setop('+i+')"></textarea> <br></span> </div>';
			}else{
                    sstt += '<div> <span class="badge badge-dark"> Q-'+i+'. </span><br> <span class="badge badge-dark"><input type="hidden" style="width:135px;" min=1 id="seq'+i+'" value="'+i+'" > Trigger/Prev QIDs <input type="text" id="pqid'+i+'" placeholder="qids ex 2,3"> having Trigger values :  <input type="text" id="tv'+i+'" placeholder="Ex. 1,2,a1,a2"> With Match Type <select id="mt'+i+'"><option value="2">Multiple Choice</option><option value="1">Signle Choice</option> </select> <br> Then reply as <textarea rows="3" cols="80" id="msg'+i+'" placeholder="Question here"></textarea> <textarea rows="3"  id="op'+i+'" placeholder="Options like 1,2 " onChange="setop('+i+')"></textarea> <br></span> </div>';
			}
                    if(i<qcount) sstt+= '<hr>';
                }
