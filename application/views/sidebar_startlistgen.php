<div id="sidebar_container">
	...
	<div class="sidebar">
		...
		<form method="get" action="<?= base_url() ?>index.php/startlist/do_eventrpt" id="search">
			<p style="padding: 0 0 9px 0;"><input class="search" type="date" name="query" placeholder=" Date"/></p>
			
			<p><a class="subscribe" href="javascript:void(0);" onclick="$('#search').submit();" >Generate App Log Report-2</a></p>
		</form>
	</div>
  
        <h3>Go to</h3>
        	<a href='index.php/startlist/v_eventrpt'>Generate Event Report-2</a><br>
