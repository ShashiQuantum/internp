...
<img src="<?php echo base_url();?>public/img/quota1.jpg" style="height:550px; width:100%;">
    <!-- Navigation -->
 ...
 <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>public/img/logos/quantum-logo-big.png" style="height:45px; width:200px; float:left;"/></a>
    ...
    <!-- About Section -->
            <div class="row">
                    <div> 
      <div class="floating-box1 col-6" style="width:300px;height:180px; padding:15px;margin: -90px 0 0 -150px;left: 85%; top:55%;position: absolute;">
        <div>
	<center><h2 style="color:white;"> PROJECT QUOTA</h2> <center><br>
	<?php echo form_open('quota/godashboard');?>
	<?php echo $login_failed=validation_errors(); ?>
        <input type=text name="key" id="key" style="width:60px;" placeholder="Code" onkeypress='return event.charCode >= 48 && event.charCode <= 57' 
maxlength="5" minlength="3" required> 
<input type=text name="mkey" id="mkey" style="width:100px;" placeholder="Your RMN" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
maxlength="10" minlength="10" required>
<input type=text name="ccode" id="ccode" style="width:50px;" placeholder="Centre Code" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
maxlength="7" minlength="1" required>
