...
<head>
    ...
    <title>CrossTab | Digiadmin</title>
...
<img src="<?php echo base_url();?>public/img/ctab.jpg" style="height:550px; width:100%;">
    <!-- Navigation -->
...
-->
    ...
    <!-- About Section -->
      ...
      <div class="floating-box1 col-6" style="width:300px;height:190px; padding:15px;margin: -100px 0 0 -200px;left: 80%; top:40%;position: absolute;">
        <div>
	<center><h2 style="color:white;">Cross Tabulation</h2> <center><br>
	<?php echo form_open('crosstab/godashboard');?>
